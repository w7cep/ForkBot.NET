...
namespace SysBot.Pokemon
{
    public sealed class DenBot : EncounterBot
    {
        ...
        protected override async Task EncounterLoop(SAV8SWSH sav, CancellationToken token)
        {
            ...
            while (!token.IsCancellationRequested)
            {
                ...
                else
                {
                    ...
                    Log("\nSeed injected, stopping the bot.");
                    return;
                }
            }
        }
        ...
        private Tuple<ulong, ulong> PerformSeedSearch()
        {
            ...
            var form = TradeCordHelperUtil<PK8>.FormOutput((int)(RaidInfo.Den.IsEvent ? RaidInfo.RaidDistributionEncounter.Species : RaidInfo.RaidEncounter.Species), (int)(RaidInfo.Den.IsEvent ? RaidInfo.RaidDistributionEncounter.AltForm : RaidInfo.RaidEncounter.AltForm), out _);
